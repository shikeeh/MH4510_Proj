...
MARS model have two hyper-parameters: the maximum degree of interactions
...
We built up a grid with 30 different combinations of interaction
...
We used the optimal hyper-parameters to train the model and then
calculated the RMSE:
...
Similar to MARS, we divided the dataset into training dataset and test
dataset first:
